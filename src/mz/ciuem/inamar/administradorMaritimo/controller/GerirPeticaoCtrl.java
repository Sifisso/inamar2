...
public class GerirPeticaoCtrl extends GenericForwardComposer{
	...
	public void onClickDarParecer(ForwardEvent e){
   	...
   	public void onClick$btn_imprimir(Event e) throws JRException{
        ...
        mapaParam.put("listNome", "Pedidos do Administrador Marítimo");
        @SuppressWarnings("unchecked")
	...
	private void listarPeticao() {
		...
		if(funcionario==null){
			...
			listPeticao = _peticaoService.buscarPeticoesPorDelegacaoAdmMaritimo(funcionario.getSector().getDelegacaoDepartamento().getDelegacao());
		}
