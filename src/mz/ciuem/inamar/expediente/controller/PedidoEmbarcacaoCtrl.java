...
public class PedidoEmbarcacaoCtrl extends GenericForwardComposer{
	...
	private void listarPeticao() {
		...
		if(funcionario==null){
			...
			listPeticao = _peticaoService.buscarPeticoesPorDelegacaoEmbarcacao(funcionario.getSector().getDelegacaoDepartamento().getDelegacao());
		}
	...
	public void onClickDetalhess(ForwardEvent e){
		Peticao pet = (Peticao) e.getData();
		_peticaoService.onClickDetalhess(pet, inc_main, div_content_out);
