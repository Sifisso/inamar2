...
public class PedidoMaritimoCtrl extends GenericForwardComposer{
	...
	private void listarPeticao() {
		...
		if(funcionario==null){
			...
			listPeticao = _peticaoService.buscarPeticoesPorDelegacaoMaritimos(funcionario.getSector().getDelegacaoDepartamento().getDelegacao());
		}
