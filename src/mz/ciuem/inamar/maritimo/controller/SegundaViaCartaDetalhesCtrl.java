...
public class SegundaViaCartaDetalhesCtrl extends GenericForwardComposer{
	...
	private void gravar() {
       ...
       CategoriaMaritimo _cm = (CategoriaMaritimo) cbx_categoriaActual.getSelectedItem().getValue();
