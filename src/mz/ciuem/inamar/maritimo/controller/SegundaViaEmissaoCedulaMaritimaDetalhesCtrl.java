...
public class SegundaViaEmissaoCedulaMaritimaDetalhesCtrl extends GenericForwardComposer{
	...
	private Textbox tbx_user, tbx_pass, tbx_nrCedula, tbx_livro, tbx_folhas;
	...
	private void listarExames(){
		List<Delegacao> listDelegacao = _delegacaoService.getAll();
		cbx_delegacao.setModel(new ListModelList<Delegacao>(listDelegacao));
	}
	
	private void preencherCampos() {
		if(_peticaoMaritimo!=null && _peticaoMaritimo.getPeticao()!=null){
			//dbx_altura.setValue(_peticaoMaritimo.getAltura());
			tbx_nrCedula.setValue(_peticaoMaritimo.getNrCedula());
			tbx_livro.setValue(_peticaoMaritimo.getNrLivro());
			tbx_folhas.setValue(_peticaoMaritimo.getNrFolhas());
			lbl_nome.setValue(_peticaoMaritimo.getPeticao().getUtente());
			lbl_contacto.setValue(_peticaoMaritimo.getPeticao().getContactoUtente());
			lbl_provincia.setValue(_peticaoMaritimo.getPeticao().getProvincia());
			lbl_distrito.setValue(_peticaoMaritimo.getPeticao().getDistritoUtente());
			lbl_tipoDoc.setValue(_peticaoMaritimo.getPeticao().getTipDocUtente());
			lbl_nrDoc.setValue(_peticaoMaritimo.getPeticao().getNrDocUtente());
			lbl_bairro.setValue(_peticaoMaritimo.getPeticao().getDataNascUtente());
			lbl_localEmissao.setValue(_peticaoMaritimo.getPeticao().getLocalEmissaoUtente());
			cbx_delegacao.setValue(_peticaoMaritimo.getDelegacao()==null?"":_peticaoMaritimo.getDelegacao().getNome());
		}
	}
	...
	private void gravar() {
		_peticaoMaritimo.setNrCedula(tbx_nrCedula.getValue());
		_peticaoMaritimo.setNrLivro(tbx_livro.getValue());
		_peticaoMaritimo.setNrFolhas(tbx_folhas.getValue());
		_peticaoMaritimo.setNrCedula(tbx_nrCedula.getValue());
		_peticaoMaritimo.setDelegacao((Delegacao)cbx_delegacao.getSelectedItem().getValue());
