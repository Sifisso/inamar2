...
public class TempoDesembarqueDetalhesCtrl extends GenericForwardComposer{
	
	private Window win_tempoTesembarque;
	...
	private Textbox tbx_user, tbx_pass, tbx_nrInscricao, tbx_nrLivro, tbx_nrFolhas, tbx_motivo;
	...
	private void verFactura() throws JRException {
	       ...
	       List<PeticaoMaritimoTaxaPedido> _list = _peticaoMaritimoTaxaPedidoService.findByPeticaoMaritimo(_peticaoMaritimo);
	   	   MasterRep.imprimir("/reportParam/facturaPedidoUtente.jrxml", _list, mapaParam, win_tempoTesembarque);
