...
public class DesembarqueDetalhesCtrl extends GenericForwardComposer{
	
	private Window win_desembarque;
	...
	private Textbox tbx_user, tbx_pass, tbx_nomeEmbarcacao, tbx_nomeMaritimo, tbx_nomePropreitario, tbx_motivo;
	...
	private void gravar() {
      _peticaoMaritimo.setNomeEmbarcacao(tbx_nomeEmbarcacao.getValue());
      _peticaoMaritimo.setNomeProprietario(tbx_nomePropreitario.getValue());
      _peticaoMaritimo.setNomeMaritimo(tbx_nomeMaritimo.getValue());
	...
	private void verFactura() throws JRException {
	       ...
	       List<PeticaoMaritimoTaxaPedido> _list = _peticaoMaritimoTaxaPedidoService.findByPeticaoMaritimo(_peticaoMaritimo);
	   	   MasterRep.imprimir("/reportParam/facturaPedidoUtente.jrxml", _list, mapaParam, win_desembarque);
	...
	private void preencherCampos() {
			if(_peticaoMaritimo!=null && _peticaoMaritimo.getPeticao()!=null){
				tbx_nomeEmbarcacao.setValue(_peticaoMaritimo.getNomeEmbarcacao());
				tbx_nomeMaritimo.setValue(_peticaoMaritimo.getNomeMaritimo());
				tbx_nomePropreitario.setValue(_peticaoMaritimo.getNomeProprietario());
