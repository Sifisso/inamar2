...
public class SubstituicaoDaCartaDetalhesCtrl extends GenericForwardComposer{
	
	private Window win_substDaCarta;
	...
	private Textbox tbx_user, tbx_pass, tbx_nrCedula, tbx_nrLivro, tbx_nrFolhas, tbx_nrCarta, tbx_nrLivroCarta, tbx_nrLFolhasCarta;
	...
	private void gravar() {
      ...
      _peticaoMaritimo.setDelegacao(cbx_delegacao.getSelectedItem().getValue());
	...
	private void verFactura() throws JRException {
	       ...
	       List<PeticaoMaritimoTaxaPedido> _list = _peticaoMaritimoTaxaPedidoService.findByPeticaoMaritimo(_peticaoMaritimo);
	   	   MasterRep.imprimir("/reportParam/facturaPedidoUtente.jrxml", _list, mapaParam, win_substDaCarta);
