...
public class AverbamentoCedulaMaritimaDetalhesCtrl extends GenericForwardComposer{
	
	private Window win_averbarCedula;
	...
	private Textbox tbx_user, tbx_pass, tbx_nrInscricao, tbx_nrLivro, tbx_nrFolhas;
	...
	private void verFactura() throws JRException {
	       ...
	       List<PeticaoMaritimoTaxaPedido> _list = _peticaoMaritimoTaxaPedidoService.findByPeticaoMaritimo(_peticaoMaritimo);
	   	   MasterRep.imprimir("/reportParam/facturaPedidoUtente.jrxml", _list, mapaParam, win_averbarCedula);
