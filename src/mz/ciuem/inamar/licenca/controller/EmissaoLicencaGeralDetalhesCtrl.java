...
public class EmissaoLicencaGeralDetalhesCtrl extends GenericForwardComposer{
	
	private Window win_emissaoLicGeral;
	...
	private Textbox tbx_user, tbx_pass, tbx_descricao, tbx_observacao;
	...
	private void preencherCampos() {
		if(_peticaoLicenca!=null && _peticaoLicenca.getPeticao()!=null){
			tbx_descricao.setValue(_peticaoLicenca.getDescricao());
			tbx_observacao.setValue(_peticaoLicenca.getObservacao());
	...
	private void gravar() {
		_peticaoLicenca.setDescricao(tbx_descricao.getValue());
		_peticaoLicenca.setObservacao(tbx_observacao.getValue());
