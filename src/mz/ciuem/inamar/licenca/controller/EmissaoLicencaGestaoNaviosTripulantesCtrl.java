...
public class EmissaoLicencaGestaoNaviosTripulantesCtrl extends GenericForwardComposer{
	...
	private void listarActividades(){
		List<ActividadeLicenca> listActividadesLicenca = _actividadeLicencaService.getAll();
		lbx_actividades.setModel(new ListModelList<ActividadeLicenca>(listActividadesLicenca));
	}
	
	private void listarLocalPratica(){
		List<LocalPratica> listLocalPratica = _localPraticaService.getAll();
	...
	public void onActivoLocal(ForwardEvent e){
		 LocalPratica localPratica = (LocalPratica) e.getData();
		 
		localPratica.setActivo(false);
		 
		 _localPraticaService.update(localPratica);
	...
	public void onInactivoLocal(ForwardEvent e){
		LocalPratica localPratica = (LocalPratica) e.getData();
				 
				localPratica.setActivo(true);
