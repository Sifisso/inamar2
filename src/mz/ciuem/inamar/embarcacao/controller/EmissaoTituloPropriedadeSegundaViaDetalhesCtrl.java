...
public class EmissaoTituloPropriedadeSegundaViaDetalhesCtrl extends GenericForwardComposer{
		 ...
		 private void ocultarCampos() {
			...
			private void verFactura() throws JRException {
			       ...
			       List<PeticaoMaritimoTaxaPedido> _list = _peticaoMaritimoTaxaPedidoService.findByPeticaoEmbarcacao(_peticaoEmbarcacao);
			   	   MasterRep.imprimir("/reportParam/facturaPedidoUtente.jrxml", _list, mapaParam, win_tituloSegundaVia);
