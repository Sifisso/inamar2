...
public class RegistoEmbarcacaoAcabadaComprarDetalhesCtrl extends GenericForwardComposer{
	...
	private Combobox cbx_servico, cbx_local, cbx_moeda;
	...
	private Textbox tbx_denominacao, tbx_nome, tbx_nr_registo, tbx_nova_denominacao, tbx_denominacao_nova;
	...
	private void pegarPeticaoEmbarcacao() {
		 ...
		 private void ocultarCampos() {
			...
			private void gravar() {
				...
				_peticaoEmbarcacao.setNova_denominacao(tbx_denominacao_nova.getValue());
				_peticaoEmbarcacao.setNome_antigo_dono(tbx_nome.getValue());
				_peticaoEmbarcacao.setLocal_registo(cbx_local.getValue());
				_peticaoEmbarcacao.setNumero_registo(tbx_nr_registo.getValue());
				_peticaoEmbarcacao.setPreco_aquisicao(dbx_preco.getValue());
				_peticaoEmbarcacao.setMoeda(cbx_moeda.getValue());
			...
			private void preencherCampos() {
				if(_peticaoEmbarcacao!=null && _peticaoEmbarcacao.getServicoDestino()!=null){
				    ...
				    tbx_denominacao_nova.setValue(_peticaoEmbarcacao.getNova_denominacao());
				    tbx_nome.setValue(_peticaoEmbarcacao.getNome_antigo_dono());
				    tbx_nr_registo.setValue(_peticaoEmbarcacao.getNumero_registo());
				    dbx_preco.setValue(_peticaoEmbarcacao.getPreco_aquisicao());
				    cbx_moeda.setValue(_peticaoEmbarcacao.getMoeda());
