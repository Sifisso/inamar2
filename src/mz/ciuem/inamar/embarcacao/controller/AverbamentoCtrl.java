...
public class AverbamentoCtrl extends GenericForwardComposer{
	...
	private Textbox tbx_marcaMotor, tbx_nrMotor, tbx_nrExpediente;
...
//		}
		...
		private void gravar() {
			...
			_peticaoEmbarcacao.setNrExpediente(tbx_nrExpediente.getValue());
		...
		private void preencherCampos() {
			if(_peticaoEmbarcacao!=null && _peticaoEmbarcacao.getPeticao()!=null){
				//_peticaoEmbarcacao = _peticaoEmbarcacaoService.findOneWithEager(_peticaoEmbarcacao.getId());
					...
					tbx_nrExpediente.setValue(_peticaoEmbarcacao.getNrExpediente());
			}
		}
