...
public class CancelamentoEmbarcacaoVendidaDetalhesCtrl extends GenericForwardComposer{
	...
	private void pegarPeticaoEmbarcacao() {
		 ...
		 private void ocultarCampos() {
			...
			private void gravar() {
				_peticaoEmbarcacao.setNome_novo_dono(tbx_nome.getValue());
				...
				_peticaoEmbarcacao.setPrecoVenda(dbx_preco.getValue());
			...
			private void verFactura() throws JRException {
			       ...
			       List<PeticaoMaritimoTaxaPedido> _list = _peticaoMaritimoTaxaPedidoService.findByPeticaoEmbarcacao(_peticaoEmbarcacao);
			   	   MasterRep.imprimir("/reportParam/facturaPedidoUtente.jrxml", _list, mapaParam, win_cancelamento);
