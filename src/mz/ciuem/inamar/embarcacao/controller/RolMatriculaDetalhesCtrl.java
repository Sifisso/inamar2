...
public class RolMatriculaDetalhesCtrl extends GenericForwardComposer{
	

	private Window win_rolMatricula;
	...
	private Textbox tbx_matricula, tbx_proprietario;
...
//		}
		...
		private void verFactura() throws JRException {
		       ...
		       List<PeticaoMaritimoTaxaPedido> _list = _peticaoMaritimoTaxaPedidoService.findByPeticaoEmbarcacao(_peticaoEmbarcacao);
		   	   MasterRep.imprimir("/reportParam/facturaPedidoUtente.jrxml", _list, mapaParam, win_rolMatricula);
